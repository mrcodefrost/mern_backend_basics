...
// app.all v/s app.use
// app.use does not allow regex and is more likely to be used for middlewares
...
// ------- Using app.get for 404 -------
// app.get('/*', (req, res) => {
//     res.sendFile(path.join(__dirname, 'views', '404.html'));
// })

// ------- Using app.all for 404 -------
app.all('*', (req,res) => {
    res.status(404);
    if(req.accepts('html')){
        res.sendFile(path.join(__dirname, 'views', '404.html'))
...
// custom error builder middleware ( keep in last )
